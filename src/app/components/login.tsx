...
import { AuthProvider, FacebookAuthProvider, getAuth, GoogleAuthProvider, signInWithRedirect } from 'firebase/auth'
...
export const Login: React.FC = props => {
  ...
  const loginHandler = (provider: AuthProvider) => {
    setAuthenticating(true)
    setError(null)
    const instance = createFirebaseInstance()

    return signInWithRedirect(getAuth(instance), provider)
  }
